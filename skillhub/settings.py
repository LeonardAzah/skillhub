...
SECRET_KEY = config("SECRET_KEY", default="django-insecure-8u#zi31=n6dsgk_--1p6+79_&&7l)2p7bo9)aip6bt)$d#q!r!")
...
KYC_MAX_FILE_SIZE_MB = 20

APPEND_SLASH = False

# Restricted to registered Flutter app origins
